...
config.General.requestName = 'ZA_MC_2018'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=ZA_MC_2018']
...
config.Data.outLFNDirBase ='/store/user/zhyuan/ZA_MC_2018_v1/'
config.Data.publication = False
config.Data.ignoreLocality = True
config.Data.allowNonValidInputDataset = True
config.Data.outputDatasetTag = 'ZA_MC_2018'
