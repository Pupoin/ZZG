...
config.General.requestName = 'MuonEG_Run2016B_v2_2016'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2016','which_data=MuonEG']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/MuonEG/Run2016B-ver2_HIPM_UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'MuonEG_Run2016B_v2_2016'
