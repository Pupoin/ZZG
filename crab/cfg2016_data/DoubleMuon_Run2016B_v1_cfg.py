...
config.General.requestName = 'DoubleMuon_Run2016B_v1_2016'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2016','which_data=DoubleMuon']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/DoubleMuon/Run2016B-ver1_HIPM_UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'DoubleMuon_Run2016B_v1_2016'
