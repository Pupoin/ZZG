...
config.General.requestName = 'ZZ_MC_2018'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=ZZ_MC_2018']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset='/ZZTo4L_TuneCP5_13TeV_powheg_pythia8/RunIISummer20UL18NanoAODv9-20UL18JMENano_106X_upgrade2018_realistic_v16_L1v1-v1/NANOAODSIM'
...
config.Data.outLFNDirBase ='/store/user/zhyuan/ZZ_MC_2018_v1/'
config.Data.publication = False
config.Data.ignoreLocality = True
config.Data.allowNonValidInputDataset = True
config.Data.outputDatasetTag = 'ZZ_MC_2018'
