...
parser.add_argument('-p','--modulePath', help='where to find the module',default= '../../../fakePhoton/')
...
#        file_content += f"config.JobType.allowUndistributedCMSSW = True\n"
        ...
        file_content += f"config.JobType.inputFiles = [\'../../../scripts/haddnano.py\',\'{modulePath}/ZZG_postproc.py\',\'{modulePath}/fakePhoton_Module.py\',\'{modulePath}/{inbranch_file}\',\'{modulePath}/{outbranch_file}\'] #hadd nano will not be needed once nano tools are in cmssw\n"
