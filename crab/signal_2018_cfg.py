...
config.General.requestName = 'signal_2018'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=signal_2018']
...
config.Data.outputDatasetTag = 'signal_2018'
