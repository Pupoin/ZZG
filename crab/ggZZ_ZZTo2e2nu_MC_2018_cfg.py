...
config.General.requestName = 'ggZZ_ZZTo2e2nu_MC_2018'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=ggZZ_ZZTo2e2nu_MC_2018']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset='/GluGluToContinToZZTo2e2nu_TuneCP5_13TeV-mcfm701-pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v2/NANOAODSIM'
...
config.Data.outputDatasetTag = 'ggZZ_ZZTo2e2nu_MC_2018'
