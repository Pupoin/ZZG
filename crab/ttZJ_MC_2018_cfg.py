...
config.General.requestName = 'ttZJ_MC_2018'
config.General.transferLogs= True
config.General.workArea = 'crab2018MC2'
...
config.JobType.scriptArgs = ['kind=MC','mode=crab','year=2018','which_data=ttZJ_MC_2018']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset='/ttZJets_TuneCP5_13TeV_madgraphMLM_pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v2/NANOAODSIM'
...
config.Data.outLFNDirBase ='/store/user/zhyuan/ttZJ_MC_2018_v1/'
config.Data.publication = False
config.Data.ignoreLocality = True
config.Data.allowNonValidInputDataset = True
config.Data.outputDatasetTag = 'ttZJ_MC_2018'
