...
config.General.requestName = 'SingleMuon_Run2017H_2017'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2017','which_data=SingleMuon']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/SingleMuon/Run2017H-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'SingleMuon_Run2017H_2017'
