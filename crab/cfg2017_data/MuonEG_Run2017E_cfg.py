...
config.General.requestName = 'MuonEG_Run2017E_2017'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2017','which_data=MuonEG']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/MuonEG/Run2017E-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'MuonEG_Run2017E_2017'
