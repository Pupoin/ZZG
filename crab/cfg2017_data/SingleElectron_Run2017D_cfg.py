...
config.General.requestName = 'SingleElectron_Run2017D_2017'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2017','which_data=SingleElectron']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/SingleElectron/Run2017D-UL2017_MiniAODv2_NanoAODv9-v2/NANOAOD'
...
config.Data.outputDatasetTag = 'SingleElectron_Run2017D_2017'
