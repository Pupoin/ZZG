...
config.General.requestName = 'DoubleMuon_Run2017G_2017'
...
config.JobType.scriptArgs = ['kind=data','mode=crab','year=2017','which_data=DoubleMuon']
config.JobType.sendPythonFolder  = True

config.section_("Data")
#config.Data.outputPrimaryDataset = 'ZZG_fakePhoton'
config.Data.inputDataset = '/DoubleMuon/Run2017G-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'DoubleMuon_Run2017G_2017'
